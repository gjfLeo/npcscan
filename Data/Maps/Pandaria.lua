...
Maps[MapID.ValeOfEternalBlossoms].NPCs = {
    ...
    [63977] = true, -- Vyraxxis
    [63978] = true, -- Kri'chon
    [154600] = true, -- Teng the Awakened 苏醒者滕顾
    [154087] = true, -- Zror'um the Infinite 无穷者兹洛昂
    [154106] = true, -- Quid 浗
    [154332] = true, -- Voidtender Malketh 愈虚者玛柯斯
    [154394] = true, -- Veskan the Fallen 堕落者维斯坎
    [154447] = true, -- Brother Meller 梅勒修士
    [154467] = true, -- Chief Mek-mek 酋长梅克梅克
    [154490] = true, -- Rijz'x the Devourer 吞噬者里吉兹克斯
    [154495] = true, -- Will of N'Zoth 恩佐斯的意志
    [154559] = true, -- Deeplord Zrihj 深渊领主兹利基
    [155958] = true, -- Tashara 塔沙拉
    [156083] = true, -- Sanguifang 绯牙
    [157153] = true, -- Ha-Li 亥离
    [157160] = true, -- Houndlord Ren 犬师任衙
    [157162] = true, -- Rei Lun 瑞龙
    [157171] = true, -- Heixi the Stonelord 岩石领主赫曦
    [157176] = true, -- The Forgotten 忘却者
    [157183] = true, -- Coagulated Anima 凝结心能
    [157266] = true, -- Kilxl the Gaping Maw 巨喉吉尔希尔
    [157267] = true, -- Escaped Mutation 逃脱的变异体
    [157279] = true, -- Stormhowl 风暴之啸
    [157287] = true, -- Dokani Obliterator 多卡尼歼灭者
    [157290] = true, -- Jade Watcher 玉石护卫
    [157291] = true, -- Spymaster Hul'ach 间谍大师胡尔阿奇
    [157443] = true, -- Xiln the Mountain 气壮河山夏凛
    [157466] = true, -- Anh-De the Loyal 丹心魁麟昂德
    [157468] = true, -- Tisiphon 提希冯
    [160810] = true, -- Harbinger Il'koxik 使徒伊科克西克
    [160825] = true, -- Amber-Shaper Esh'ri 琥珀塑形者艾什利
    [160826] = true, -- Hive-Guard Naz'ruzek 虫巢卫士纳兹鲁泽克
    [160867] = true, -- Kzit'kovok 克兹特科沃克
    [160868] = true, -- Harrier Nir'verash 劫猎者尼尔维拉什
    [160872] = true, -- Destroyer Krox'tazar 毁灭者寇克斯塔扎
    [160874] = true, -- Drone Keeper Ak'thet 工虫守护者阿克赛特
    [160876] = true, -- Enraged Amber Elemental 被激怒的琥珀元素
    [160878] = true, -- Buh'gzaki the Blasphemous 亵渎者巴格扎基
    [160893] = true, -- Captain Vor'lek 沃雷克队长
    [160906] = true, -- Skiver 切割者
    [160920] = true, -- Kal'tik the Blight 凋零的卡尔提克
    [160922] = true, -- Needler Zhesalla 刺针者泽沙拉
    [160930] = true, -- Infused Amber Ooze 注能的琥珀软泥怪
    [160968] = true, -- Jade Colossus 青玉巨神像
    [163042] = true -- 皎白云端翔龙
}
