...
NPCs[154600] = {
    -- Teng the Awakened 苏醒者滕顾
    questID = 56332,
    vignetteID = 3734 -- Teng the Awakened
}
NPCs[154087] = {
    -- Zror'um the Infinite 无穷者兹洛昂
    questID = 56084,
    vignetteID = 3655 -- Zror'um the Infinite
}
NPCs[154106] = {
    -- Quid 浗
    questID = 56094,
    vignetteID = 3662 -- Quid
}
NPCs[154332] = {
    -- Voidtender Malketh 愈虚者玛柯斯
    questID = 56183,
    vignetteID = 3688 -- Voidtender Malketh
}
NPCs[154394] = {
    -- Veskan the Fallen 堕落者维斯坎
    questID = 56213,
    vignetteID = 3691 -- Veskan the Fallen
}
NPCs[154447] = {
    -- Brother Meller 梅勒修士
    questID = 56237,
    vignetteID = 3692 -- Brother Meller
}
NPCs[154467] = {
    -- Chief Mek-mek 酋长梅克梅克
    questID = 56255,
    vignetteID = 3693 -- Chief Mek-mek
}
NPCs[154490] = {
    -- Rijz'x the Devourer 吞噬者里吉兹克斯
    questID = 56302,
    vignetteID = 3698 -- Rijz'x the Devourer
}
NPCs[154495] = {
    -- Will of N'Zoth 恩佐斯的意志
    questID = 56303,
    vignetteID = 3703 -- Will of N'Zoth
}
NPCs[154559] = {
    -- Deeplord Zrihj 深渊领主兹利基
    questID = 56323,
    vignetteID = 3733 -- Deeplord Zrihj
}
NPCs[155958] = {
    -- Tashara 塔沙拉
    questID = 58507,
    vignetteID = 4111 -- Tashara
}
NPCs[156083] = {
    -- Sanguifang 绯牙
    questID = 56954,
    vignetteID = 3765 -- Sanguifang
}
NPCs[157153] = {
    -- Ha-Li 亥离
    questID = 57344,
    vignetteID = 3795 -- Ha-Li
}
NPCs[157160] = {
    -- Houndlord Ren 犬师任衙
    questID = 57345,
    vignetteID = 3797 -- Houndlord Ren
}
NPCs[157162] = {
    -- Rei Lun 瑞龙
    questID = 57346,
    vignetteID = 3798 -- Rei Lun
}
NPCs[157171] = {
    -- Heixi the Stonelord 岩石领主赫曦
    questID = 57347,
    vignetteID = 3805 -- Heixi the Stonelord
}
NPCs[157176] = {
    -- The Forgotten 忘却者
    questID = 57342,
    vignetteID = 3807 -- The Forgotten
}
NPCs[157183] = {
    -- Coagulated Anima 凝结心能
    questID = 58296,
    vignetteID = 3808 -- Coagulated Anima
}
NPCs[157266] = {
    -- Kilxl the Gaping Maw 巨喉吉尔希尔
    questID = 57341,
    vignetteID = 3810 -- Kilxl the Gaping Maw
}
NPCs[157267] = {
    -- Escaped Mutation 逃脱的变异体
    questID = 57343,
    vignetteID = 3811 -- Escaped Mutation
}
NPCs[157279] = {
    -- Stormhowl 风暴之啸
    questID = 57348,
    vignetteID = 3812 -- Stormhowl
}
NPCs[157287] = {
    -- Dokani Obliterator 多卡尼歼灭者
    questID = 57349,
    vignetteID = 3813 -- Dokani Obliterator
}
NPCs[157290] = {
    -- Jade Watcher 玉石护卫
    questID = 57350,
    vignetteID = 3814 -- Jade Watcher
}
NPCs[157291] = {
    -- Spymaster Hul'ach 间谍大师胡尔阿奇
    questID = 57351,
    vignetteID = 3815 -- Spymaster Hul'ach
}
NPCs[157443] = {
    -- Xiln the Mountain 气壮河山夏凛
    questID = 57358,
    vignetteID = 3817 -- Xiln the Mountain
}
NPCs[157466] = {
    -- Anh-De the Loyal 丹心魁麟昂德
    questID = 57363,
    vignetteID = 3819 -- Anh-De the Loyal
}
NPCs[157468] = {
    -- Tisiphon 提希冯
    questID = 57364,
    vignetteID = 3820 -- Tisiphon
}
NPCs[160810] = {
    -- Harbinger Il'koxik 使徒伊科克西克
    questID = 58299,
    vignetteID = 3989 -- Harbinger Il'koxik
}
NPCs[160825] = {
    -- Amber-Shaper Esh'ri 琥珀塑形者艾什利
    questID = 58300,
    vignetteID = 3990 -- Amber-Shaper Esh'ri
}
NPCs[160826] = {
    -- Hive-Guard Naz'ruzek 虫巢卫士纳兹鲁泽克
    questID = 58301,
    vignetteID = 3991 -- Hive-Guard Naz'ruzek
}
NPCs[160867] = {
    -- Kzit'kovok 克兹特科沃克
    questID = 58302,
    vignetteID = 3992 -- Kzit'kovok
}
NPCs[160868] = {
    -- Harrier Nir'verash 劫猎者尼尔维拉什
    questID = 58303,
    vignetteID = 3993 -- Harrier Nir'verash
}
NPCs[160872] = {
    -- Destroyer Krox'tazar 毁灭者寇克斯塔扎
    questID = 58304,
    vignetteID = 3994 -- Destroyer Krox'tazar
}
NPCs[160874] = {
    -- Drone Keeper Ak'thet 工虫守护者阿克赛特
    questID = 58305,
    vignetteID = 3995 -- Drone Keeper Ak'thet
}
NPCs[160876] = {
    -- Enraged Amber Elemental 被激怒的琥珀元素
    questID = 58306,
    vignetteID = 3996 -- Enraged Amber Elemental
}
NPCs[160878] = {
    -- Buh'gzaki the Blasphemous 亵渎者巴格扎基
    questID = 58307,
    vignetteID = 3997 -- Buh'gzaki the Blasphemous
}
NPCs[160893] = {
    -- Captain Vor'lek 沃雷克队长
    questID = 58308,
    vignetteID = 3998 -- Captain Vor'lek
}
NPCs[160906] = {
    -- Skiver 切割者
    questID = 58309,
    vignetteID = 3999 -- Skiver
}
NPCs[160920] = {
    -- Kal'tik the Blight 凋零的卡尔提克
    questID = 58310,
    vignetteID = 4000 -- Kal'tik the Blight
}
NPCs[160922] = {
    -- Needler Zhesalla 刺针者泽沙拉
    questID = 58311,
    vignetteID = 4001 -- Needler Zhesalla
}
NPCs[160930] = {
    -- Infused Amber Ooze 注能的琥珀软泥怪
    questID = 58312,
    vignetteID = 4002 -- Infused Amber Ooze
}
NPCs[160968] = {
    -- Jade Colossus 青玉巨神像
    questID = 58295,
    vignetteID = 3988 -- Jade Colossus
}
